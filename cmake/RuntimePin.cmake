...
# Bump procedure: update ETNP_RUNTIME_VERSION/SHA256 below to the next `v<etver>-<pkgrev>`
# executorch-runtime-dist release. The SHA256 change is the supply-chain review gate; CI's
# separate `gh attestation verify` step covers provenance (see docs on CI setup).
...
set(ETNP_RUNTIME_URL_logging_linux-x86_64
  "https://github.com/measly-java-learning/executorch-runtime-dist/releases/download/v${ETNP_RUNTIME_VERSION}/executorch-runtime-${ETNP_ET_VERSION}-logging-linux-x86_64.tar.gz")
